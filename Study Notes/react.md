...
Even though portals may render in a different DOM element than where it is being called, it will still depend on it's actual parent. Will have event bubbling the same.
